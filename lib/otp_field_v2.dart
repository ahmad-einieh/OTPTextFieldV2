...
class OTPTextFieldV2 extends StatefulWidget {
  ...
  @override
  OTPTextFieldV2State createState() => OTPTextFieldV2State();
}

class OTPTextFieldV2State extends State<OTPTextFieldV2> {
  ...
  @override
  void didUpdateWidget(covariant OTPTextFieldV2 oldWidget) {
...
class OtpFieldControllerV2 {
  late OTPTextFieldV2State _otpTextFieldState;

  void setOtpTextFieldState(OTPTextFieldV2State state) {
